...
//		this.repository.save(new Employee("Augusto", "Uehara", "developer"));
//		this.repository.save(new Employee("Sophia", "Wei", "CTO"));
//		this.repository.save(new Employee("Joseph", "Mackenzie", "CEO"));
//		this.repository.save(new Employee("Maddie", "Shek", "Kid"));
//	}
//}
//// end::code[]